...
INSERT INTO _allowed_packages(name, sessions_count, price_cents) VALUES
  ($$Bono 10 masajes Piernas Cansadas$$, 10, 38200),
  ($$Bono 10 masajes 75'$$, 10, 68000),
  ($$Bono 10 masajes 45' para dos Personas$$, 10, 76500),
  ($$Bono 5 masajes Piernas Cansadas$$, 5, 19800),
  ($$Bono 5 masajes 75' para dos Personas$$, 5, 61500),
  ($$Bono 5 masajes 45' para dos Personas$$, 5, 39600),
  ($$Bono 10 masajes 55'$$, 10, 51000),
  ($$Bono 10 masajes Futura Mamá 50'$$, 10, 51000),
  ($$Bono 10 sesiones Anticelulítico / Reductor$$, 10, 51000),
  ($$Bono 10 sesiones de Shiatsu$$, 10, 51000),
  ($$Bono 10 sesiones Drenaje Linfático$$, 10, 63500),
  ($$Bono 5 masajes 55'$$, 5, 26400),
  ($$Bono 5 masajes 75'$$, 5, 35500),
  ($$Bono 5 masajes Futura Mamá 50'$$, 5, 26400),
  ($$Bono 5 Rituales Kobido Individual$$, 5, 39600),
  ($$Bono 5 sesiones Anticelulítico / Reductor$$, 5, 26400),
  ($$Bono 5 sesiones de Shiatsu$$, 5, 26400),
  ($$Bono 5 sesiones Drenaje Linfático$$, 5, 33000),
  ($$Bono 10 masajes 110'$$, 10, 97500),
  ($$Bono 5 masajes 110'$$, 5, 50500),
  ($$Bono 5 masajes Futura Mamá 75'$$, 5, 35500);
