...
const ServiceModal: React.FC<Props> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl w-[95vw] max-h-[75vh] overflow-hidden flex flex-col bg-gradient-to-br from-background to-accent/5 fixed top-[75%] left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[9999]">
