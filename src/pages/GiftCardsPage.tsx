  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <Dialog open={isCartOpen} onOpenChange={setIsCartOpen}>
        <DialogContent className="!fixed !top-[55%] !left-1/2 !transform !-translate-x-1/2 !-translate-y-1/2 !z-[9999] max-w-[90vw] sm:max-w-[480px] max-h-[80vh] overflow-hidden flex flex-col p-0">
