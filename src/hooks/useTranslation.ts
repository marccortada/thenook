...
const translations = {
  es: {
    ...
    "secure_payment_info": "Se abrirá una nueva ventana segura para completar tu compra. La tarjeta regalo se enviará automáticamente por email al comprador y al beneficiario.",
    ...
    "add": "Añadir",
    "value_min_max_note": "Valor mínimo: 10€ - Valor máximo: 500€",
  ...
  en: {
    ...
    "secure_payment_info": "A secure window will open to complete your purchase. The gift card will be automatically sent by email to the buyer and the recipient.",
    ...
    "customize_gift_card_title": "Customize Gift Card",
    "customize_gift_card_description_prefix": "Select the gift card amount for",
    "gift_card_group_individual": "Gift Card - Individual Massage",
    "gift_card_group_couples": "Gift Card - Couples Massage",
    "gift_card_group_four_hands": "Gift Card - Four Hands Massage",
    "gift_card_group_individual_rituals": "Gift Card - Individual Rituals",
